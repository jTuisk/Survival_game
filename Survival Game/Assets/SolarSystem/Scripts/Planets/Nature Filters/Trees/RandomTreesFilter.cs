...
{
    public class RandomTreesFilter : INatureNoiseFilter
    {
        ShapeGenerator shapeGenerator;
        ForestSettings.RandomTrees forestSettings;
        Noise noise;

        GameObject _parent;

        public RandomTreesFilter(ForestSettings.RandomTrees forestSettings, ShapeGenerator shapeGenerator)
        {
